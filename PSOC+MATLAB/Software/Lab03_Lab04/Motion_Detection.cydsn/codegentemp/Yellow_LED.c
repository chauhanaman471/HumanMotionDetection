...
{
    uint8 staticBits = (Yellow_LED_DR & (uint8)(~Yellow_LED_MASK));
    Yellow_LED_DR = staticBits | ((uint8)(value << Yellow_LED_SHIFT) & Yellow_LED_MASK);
}
...
{
	CyPins_SetPinDriveMode(Yellow_LED_0, mode);
}
...
{
    return (Yellow_LED_PS & Yellow_LED_MASK) >> Yellow_LED_SHIFT;
}
...
{
    return (Yellow_LED_DR & Yellow_LED_MASK) >> Yellow_LED_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Yellow_LED_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Yellow_LED_0_INTR) != 0u) 
		{ 
			 Yellow_LED_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Yellow_LED_INTSTAT & Yellow_LED_MASK) >> Yellow_LED_SHIFT;
    }
