...
#define WaveDAC8_1_WAVE1_LENGTH   (4000u)   /* Length for wave1 */
#define WaveDAC8_1_WAVE2_LENGTH   (100u)   /* Length for wave2 */
	
#define WaveDAC8_1_DEFAULT_RANGE    (1u) /* Default DAC range */
...
#define WaveDAC8_1_DAC_RANGE      ((uint8)(1u << 2u) & WaveDAC8_1_RANGE_MASK)
#define WaveDAC8_1_DAC_POL        ((uint8)(1u >> 1u) & WaveDAC8_1_IDIR_MASK)
